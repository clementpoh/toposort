...
/* Returns the node equal to key in list, returns NULL if not found */
extern List find(bool (*eq)(void *key, void *node), void *key, List list);

/* Removes and returns the element equal to key in list,
 * returns NULL if not found */
extern void *del(bool (*eq)(void *key, void *node), void *key, List *list);
...
/* Print list to f by applying print to each node that is not NULL */
extern void print_list_rev(void (*print)(FILE *f, void *data), FILE *f, List node);
